...
# 30k
${RUN} /inspire/hdd/global_user/gongjingjing-25039/lqyin/OneTwoVLA/checkpoints/pifast_w_vlabench_delta_cotrain_eb/2026.05.18/06.10.04/pifast-vlabench/99999 ${OPTS_1}
${RUN} /inspire/hdd/global_user/gongjingjing-25039/lqyin/OneTwoVLA/checkpoints/pifast_w_vlabench_delta_cotrain_eb/2026.05.18/06.10.04/pifast-vlabench/99999 ${OPTS_2}
