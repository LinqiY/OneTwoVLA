...
XLA_PYTHON_CLIENT_MEM_FRACTION=0.95 python scripts/train_cotrain.py pifast_w_vlabench_delta_steer_track1_094_track2_006 \
  --exp-name="${now_date}/${now_seconds}/pifast_w_vlabench_delta_steer_track1_094_track2_006" \
