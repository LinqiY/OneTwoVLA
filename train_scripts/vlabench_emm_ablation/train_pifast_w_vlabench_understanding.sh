...
XLA_PYTHON_CLIENT_MEM_FRACTION=0.95 python scripts/train_cotrain.py pifast_w_vlabench_relative_cotrain_understanding \
  --exp-name="2026.05.15/13.57.51/pifast-w-vlabench-cotrain-mm-data" \
