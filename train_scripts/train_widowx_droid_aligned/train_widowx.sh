...
DATASET_PATH=/inspire/hdd/global_user/gongjingjing-25039/lqyin/widowX_dataset/lerobot_2_1/new_bag
...
EXP_NAME=${now_date}/${now_seconds}/pifast-widowx-new-bag
