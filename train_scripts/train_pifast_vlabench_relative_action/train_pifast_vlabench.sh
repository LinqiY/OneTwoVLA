...
# XLA_PYTHON_CLIENT_MEM_FRACTION=0.95 python scripts/train.py pifast_vlabench_pretrain_primitive --exp-name=${now_date}/${now_seconds}/pifast-vlabench --batch-size=$batch_size
XLA_PYTHON_CLIENT_MEM_FRACTION=0.95 python scripts/train.py pifast_vlabench_pretrain_primitive --exp-name=2026.04.17/19.40.02/pifast-vlabench --batch-size=$batch_size --resume
