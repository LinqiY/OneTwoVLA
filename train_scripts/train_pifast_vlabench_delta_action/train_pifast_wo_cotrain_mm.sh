...
XLA_PYTHON_CLIENT_MEM_FRACTION=0.95 python scripts/train_cotrain.py pifast_vlabench_delta_cotrain_mm --exp-name=${now_date}/${now_seconds}/pifast-vlabench --batch-size=$batch_size --save_interval=10000
